...
import com.fastjob.ui.effects.LoadJobLanguagesEffect
        ...
        LazyColumn(
            ...
            itemsIndexed(languageList) { _, item ->
                LanguageCard(
                    ...
                    edit = {
                        navController.navigate(AppScreens.CompanyUpdateJobLanguageScreen.route + "/${viewModel.getJobId()}/${it}")
                    },
                    delete = {
