...
import com.fastjob.ui.components.candidate.LanguageCard
import com.fastjob.ui.effects.CandidateCardLoadLanguagesEffect
 ...
 */
@Composable
fun CandidateCardLanguageList(
    itemsRefreshOffset: Int = 1,
    viewModel: CandidateCardLanguageListViewModel
) {
    ...
    CandidateCardLoadLanguagesEffect(
        viewModel = viewModel,
        ...
        LazyColumn(
            ...
            when (loadState) {
                ...
                LoadState.NOT_FOUND -> {
                    item {
                        ErrorItem(
                            text = stringResource(id = R.string.language_not_found)
                        )
                    }
                }
