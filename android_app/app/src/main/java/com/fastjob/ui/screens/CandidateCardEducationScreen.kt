...
import com.fastjob.ui.components.company.CandidateCardEducationList
...
import com.fastjob.ui.viewmodels.company.CandidateCardEducationListViewModelFactory
 ...
 */
@Composable
fun CandidateCardEducationScreen(
    ...
    // view model
    val viewModel: CandidateCardEducationListViewModel = viewModel(
        factory = CandidateCardEducationListViewModelFactory(
            jobId = jobId,
