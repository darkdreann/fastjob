...
DESCRIPTIONS_ID =  {
    "ADRESS_ID": "El id de la dirección.",
    ...
    "COMPANY_ID" : "El id de la empresa a la que pertenece la oferta.",
    "JOB_ID" : "El id de la oferta.",
...
class UserDescriptions:
    ...
    USERNAME = "El username usado para log in."
    EMAIL = "El email del usuario también puede ser usado para log in."
    NAME = "El nombre del usuario."
    SURNAME = "El apellido del usuario."
    PHONE_NUMBER = "Lista con los teléfonos del usuario."
    PASSWORD = "La contraseña del usuario."
    ADRESS = "La dirección del usuario."
    USER_TYPE = "El tipo de usuario."
    DELETED = "La fecha de borrado del usuario. Si no esta programado para ser borrado es None." 
...
class CompanyDescription:
    ...
    JOB = "Lista con las ofertas de trabajo de la empresa."
...
class ExperienceDescription:
    ...
    END_DATE = "Fecha cuando termino el trabajo. Puede ser vacio si el candiddato sigue trabajando."
...
class LevelDescription:
    ...
    NAME = "El nombre del nivel de la formación o idioma.(Grado Superior|C1)"
    LEVEL_ID = DESCRIPTIONS_ID["LEVEL_ID"]
...
class JobDescription:
    ...
    WORK_SHEDULE = "La jornada requerida en la oferta."
